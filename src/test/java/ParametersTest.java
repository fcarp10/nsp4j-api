...
public class ParametersTest {
   ...
   public void parameters() throws URISyntaxException {
      ...
      Parameters pm = ConfigFiles.readParameters(path, "/example.yml");
      pm.initialize(path);
      ...
      assertNotNull(service.getAttribute(SERVICE_FUNCTIONS_PER_SERVER));
      ...
      assertNotNull(function.getAttribute(FUNCTION_MAX_DELAY));
      assertNotNull(function.getAttribute(FUNCTION_MAX_INSTANCES));
